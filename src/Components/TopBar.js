...
export function TopBar() {
    return(
        <div class="row top-bar bg-primary p-2">
            ...
            <div class="cart-badge col-auto px-2 border border-secondary">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="100%" fill="currentColor" class="bi bi-cart2" viewBox="0 0 16 16">
