            ...
            <div className="tabs-container">
                <div className="bloc-tabs">
                    <div className={toggleState === 0 ? "tabs active-tabs" : "tabs"}
                        onClick={() => toggleTab(0)}>
                        <h6>Tất cả</h6>
                        <p>{numOfOrder(0)} đơn hàng</p>
                    </div>
                    <div className={toggleState === 1 ? "tabs active-tabs" : "tabs"}
                        onClick={() => toggleTab(1)}>
                        <h6>Đang chờ xác nhận</h6>
                        <p>{numOfOrder(1)} đơn hàng</p>
                    </div>
                    <div className={toggleState === 2 ? "tabs active-tabs" : "tabs"}
                        onClick={() => toggleTab(2)}>
                        <h6>Đang đợi gửi</h6>
                        <p>{numOfOrder(2)} đơn hàng</p>
                    </div>
                    <div className={toggleState === 3 ? "tabs active-tabs" : "tabs"}
                        onClick={() => toggleTab(3)}>
                        <h6>Đang đỗ</h6>
                        <p>{numOfOrder(3)} đơn hàng</p>
                    </div>
                    <div className={toggleState === 4 ? "tabs active-tabs" : "tabs"}
                        onClick={() => toggleTab(4)}>
                        <h6>Hoàn tất</h6>
                        <p>{numOfOrder(4)} đơn hàng</p>
                    </div>
                    <div className={toggleState === 5 ? "tabs active-tabs" : "tabs"}
                        onClick={() => toggleTab(5)}>
                        <h6>Đã hủy</h6>
                        <p>{numOfOrder(5)} đơn hàng</p>
                    </div>
                </div>
